...
width_to_height_ratio = 2.8  # For example, 16:9 ratio

fig, ax = plt.subplots(figsize=(12, 12 / width_to_height_ratio))    
    
ax.set_xlim(-0.3,40)# use 57 for 30%, and 38 for other percentages
ax.set_ylim(-2,100)
...
ax.legend(prop={'family': 'Times New Roman'}, loc='lower right', bbox_to_anchor=(0.173, 0.68))
